...
public class SystemAdapter {
   ...
   * @param description the description of the Requirement to be added
   * @param estimateTime the estimate time of the Requirement to be added
   * @param status the status of the Requirement to be added
